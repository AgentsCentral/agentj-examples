...
import static com.agentj.multiagent.banking.BankingAgents.bankingSystem;

public class BankingChatSystem {

    public static void main(String[] args) throws Exception {


        final HttpConfig bankingChatConfig = new HttpConfig("/chat/*", bankingSystem());
